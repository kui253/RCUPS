...
class Seq2SeqTrainer(Trainer):
    ...
    def prediction_step(
        ...
        sent_input_ids = inputs.get("sent_input_ids", None)
        sent_attention_mask = inputs.get("sent_attention_mask", None)
        importance_label = inputs.get("importance_label", None)
        len_ls = inputs.get("len_ls", None)
